...
<template>
    <div class="app-container">
        <div class="max-w-[1090px] w-full mx-auto space-y-6">
            <div class="w-full space-y-5 max-w-[580px]">
                <WhiteButtonBg>
                    <Button variant="quaternary" class="!px-8 !py-2">
                        News & Updates
                    </Button>
                </WhiteButtonBg>
                ...
                <div class="w-full space-y-1">
                    <SectionTitle>
                        <span class="text-primary-300">The Elliot Journal</span>
                    </SectionTitle>
                    <CardDetails>
            ...
            <div class="w-full grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="w-full aspect-square rounded-4xl overflow-hidden border-2 p-1 border-neutral-100">
                    <div class="w-full h-full relative rounded-[28px] overflow-hidden">
                        <img :src="activeNews?.img" alt="img" class="w-full h-full object-cover">
                        <div
                ...
                <div class="w-full">
                    <div v-for="news in newsUpdate" :key="news.id" class="py-3 md:py-6 md:px-8 flex items-center gap-6">
                        <div
                            ...
                            <div class="w-full h-full relative rounded-[6px] overflow-hidden">
                                <img :src="news?.img" alt="img" class="size-full">
                            </div>
                        </div>
